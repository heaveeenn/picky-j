// gohjpllcolmccldfdggmamodembldgpc 의 캐릭터 데이터입니다.
// 이 데이터는 캐릭터의 모든 행동 패턴, 애니메이션 프레임, 스프라이트 정보를 정의합니다.
// CSP 'unsafe-eval' 오류를 해결하기 위해 모든 표현식 문자열을 즉시 실행 가능한 함수로 변환했습니다.
export const shimejiData = {
  ...
  actions: [
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          type: "Reference",
          name: "SitAndDangleLegs",
          duration: (mascot, Math) => 500 + Math.random() * 100,
        },
        {
          type: "Reference",
          name: "SitWithLegsDown",
    ...
    },
    {
      type: "Sequence",
      name: "SitAndSpinHead",
      actions: [{ type: "Reference", name: "SitAndSpinHeadAction" }],
    },
    {
      type: "Embedded",
      name: "PullUpShimeji1",
    ...
    },
    {
      ...
      actions: [
        ...
        { type: "Reference", name: "PullUpShimeji2" },
        {
          type: "Reference",
          name: "Falling",
          initialVx: (mascot) => mascot.lookRight ? -20 : 20,
        },
        { type: "Reference", name: "Bouncing" },
      ...
      actions: [
        {
          type: "Reference",
          name: "Falling",
          initialVx: (mascot) => mascot.lookRight ? 10 : -10,
          initialVy: "-40",
        },
        { type: "Reference", name: "Bouncing" },
      ],
    ...
    // =========================================================================
    // 'jump to...'와 'throw element...'의 실제 동작 방식을 구현하기 위해 새로 추가된 액션들
    // =========================================================================
    {
  ...
  spritesheet: "/images/characters/group-finity-blank-guy.png",
  sprites: {
  ...
  metadata: {
    ...
    iconUrl:
      "https://sprite.shimejis.xyz/directory/group-finity-blank-guy/icon.png",
    thumbnailUrl:
      "https://sprite.shimejis.xyz/directory/group-finity-blank-guy/img/shime1.png",
  },
};
